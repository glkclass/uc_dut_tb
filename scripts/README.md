...
- Create `<repo>/scripts/.user_env` file to contain customized env variables in case of need. For details see `.env` file containing default values of env variables. Something like this:
```
